#ifndef TEA_SHADOWS_INCLUDED
#define TEA_SHADOWS_INCLUDED
...
#define MAX_SHADOWWS_DIRECTIONAL_LIGHT_COUNT 4
...
CBUFFER_START(_TeaShadows)
    int _CascadeCount;
    float4 _CascadeCullingSpheres[MAX_CASCADE_COUNT];
    float4 _CascadeData[MAX_CASCADE_COUNT];
    float4x4 _DirectionalShadowMatrices[MAX_SHADOWWS_DIRECTIONAL_LIGHT_COUNT * MAX_CASCADE_COUNT];
